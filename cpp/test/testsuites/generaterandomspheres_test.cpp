...
public:
    ...
    static TestResult test11() {
        ...
        puma::export_3DTiff(&sphereWS,puma::PString::get_puma_directory()+"cpp/test/out/tiff/Generate_RandomSpheres_Test11.tif",false);
        ...
        Export_STL test(&Triangles,false,puma::PString::get_puma_directory()+"cpp/test/out/stl/Generate_RandomSpheres_Test11.stl");
    ...
    static TestResult test12() {
        ...
        puma::export_3DTiff(&sphereWS,puma::PString::get_puma_directory()+"cpp/test/out/tiff/Generate_RandomSpheres_Test12.tif",false);

        std::vector<puma::Triangle<float> > Triangles;
        puma::isosurface_MarchingCubes(&Triangles,&sphereWS,puma::Cutoff(128,255),true,1,false);

        Export_STL test(&Triangles,false,puma::PString::get_puma_directory()+"cpp/test/out/stl/Generate_RandomSpheres_Test12.stl");
    ...
    static TestResult test13() {
        ...
        puma::export_3DTiff(&sphereWS,puma::PString::get_puma_directory()+"cpp/test/out/tiff/Generate_RandomSpheres_Test13.tif",false);

        std::vector<puma::Triangle<float> > Triangles;
        puma::isosurface_MarchingCubes(&Triangles,&sphereWS,puma::Cutoff(128,255),true,1,false);

        Export_STL test(&Triangles,false,puma::PString::get_puma_directory()+"cpp/test/out/stl/Generate_RandomSpheres_Test13.stl");
