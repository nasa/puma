...
//        tests.push_back(test26);
    ...
    static TestResult test9() {
        ...
        puma::import_3DTiff(&segWS,SubTest::puma_dir+"/cpp/test/tiff/segWS/1300_Spheres.tif",0);
    ...
    static TestResult test10() {
        ...
        puma::import_3DTiff(&grayWS,SubTest::puma_dir+"/cpp/test/tiff/grayWS/1300_Spheres.tif",0);
    ...
    static TestResult test11() {
        ...
        puma::import_3DTiff(&segWS,SubTest::puma_dir+"/cpp/test/tiff/segWS/200_FiberForm.tif",0);
