...
public:
    ...
    static TestResult test1() {
        ...
        puma::export_bin(&workspace,SubTest::puma_dir+"/cpp/test/out/bin/test");

        //test 1 : zero numThreads, valid file - should return true
        puma::Workspace workspace2;
        bool success2 = puma::import_bin(&workspace2,SubTest::puma_dir+"/cpp/test/out/bin/test.puma",0);
        ...
        bool success3 = puma::import_bin(&workspace3,SubTest::puma_dir+"/cpp/test/out/bin/test.puma",-5);
        ...
        bool success4 = puma::import_bin(&workspace4,SubTest::puma_dir+"/cpp/test/out/bin/test.puma",5);
        ...
        bool success5 = puma::import_bin(&workspace5,SubTest::puma_dir+"/cpp/test/out/tessdfasdfasdf.puasdfma",0);
    ...
    static TestResult test2() {
        ...
        puma::export_bin(&matrix,SubTest::puma_dir+"/cpp/test/out/bin/test");

        //test 1 : zero numThreads, valid file - should return true
        puma::Matrix<double> matrix2;
        bool success2 = puma::import_bin(&matrix2,SubTest::puma_dir+"/cpp/test/out/bin/test.puma",0);
        if(!assertEquals((bool)true,success2, &result)) {
            return result;
        }
        ...
        bool success3 = puma::import_bin(&matrix3,SubTest::puma_dir+"/cpp/test/out/bin/test.puma",-5);
        if(!assertEquals((bool)true,success3, &result)) {
            return result;
        }
        ...
        bool success4 = puma::import_bin(&matrix4,SubTest::puma_dir+"/cpp/test/out/bin/test.puma",5);
        if(!assertEquals((bool)true,success4, &result)) {
            return result;
        }
        ...
        bool success5 = puma::import_bin(&matrix5,SubTest::puma_dir+"/cpp/test/out/tessdfasdfasdf.puasdfma",0);
        if(!assertEquals((bool)false,success5, &result)) {
            return result;
        }
