...
public:
    ...
    static TestResult test4() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_sphere_r40.tif",2147483647);
        ...
        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_sphere_r40.tif",1000);
    ...
    static TestResult test5() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_sphere_r40.tif",-10);
    ...
    static TestResult test6() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_sphere_r40.tif",0);
    ...
    static TestResult test8() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/NoFile.tif",0);
    ...
    static TestResult test9() {
        ...
        puma::import_3DTiff(&grayWS,"python/pumapy/data/200_fiberform.tif",0,199,0,199,0,199,0);
    ...
    static TestResult test11() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/1300_Spheres.tif",0,1299,0,1299,0,1299,0);
    ...
    static TestResult test12() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_sphere_r40.tif",0,99,0,99,0,99,2147483647);
        ...
        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_sphere_r40.tif",0,99,0,99,0,99,1000);
    ...
    static TestResult test13() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_sphere_r40.tif",0,99,0,99,0,99,-10);
    ...
    static TestResult test14() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_sphere_r40.tif",0,99,0,99,0,99,0);
    ...
    static TestResult test16() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/NoFile.tif",0,99,0,99,0,99,0);
    ...
    static TestResult test17() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",50,99,0,99,0,99,0);
        ...
        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",-2147483647,99,0,99,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",-1,99,0,99,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",20,100,0,99,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",20,19,0,99,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",20,2147483647,0,99,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",99,99,0,99,0,99,0);
        ...
        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,0,0,99,0,99,0);
    ...
    static TestResult test18() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,50,99,0,99,0);
        ...
        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,-2147483647,99,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,-1,99,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,20,100,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,20,19,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,20,2147483647,0,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,99,99,0,99,0);
        ...
        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,0,0,0,99,0);
    ...
    static TestResult test19() {
        ...
        bool success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,0,99,50,99,0);
        ...
        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,0,99,-2147483647,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,0,99,-1,99,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,0,99,20,100,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,0,99,20,19,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,0,99,20,2147483647,0);

        if(!assertEquals((bool)false,(bool)success, &result)) {
            return result;
        }

        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,0,99,99,99,0);
        ...
        success = puma::import_3DTiff(&grayWS,"python/pumapy/data/100_fiberform.tif",0,99,0,99,0,0,0);
