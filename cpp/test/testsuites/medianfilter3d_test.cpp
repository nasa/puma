...
class MedianFilter3D_Test : public SubTest {
public:

    MedianFilter3D_Test() {

        testSuiteName = "MedianFilter3D_Test";
    ...
    static TestResult test1() {
        ...
        std::string suiteName = "MedianFilter3D_Test";
        std::string testName = "MedianFilter3D_Test: size=0, window_radius=3";
        ...
        bool success = puma::filter_Median3D(&grayWS,3);
    ...
    static TestResult test2() {
        ...
        std::string suiteName = "MedianFilter3D_Test";
        std::string testName = "MedianFilter3D_Test: size=200^3, window_radius=-1";
        ...
        bool success = puma::filter_Median3D(&grayWS,-1);
    ...
    static TestResult test3() {
        ...
        std::string suiteName = "MedianFilter3D_Test";
        std::string testName = "MedianFilter3D_Test: size=200^3, window_radius=0";
        std::string testDescription = "Should return false because of invalid window radius size (0) ";
        ...
        bool success = puma::filter_Median3D(&grayWS,0);
    ...
    static TestResult test4() {
        ...
        std::string suiteName = "MedianFilter3D_Test";
        std::string testName = "MedianFilter3D_Test: size=200^3, window_radius=1e9";
        ...
        bool success = puma::filter_Median3D(&grayWS,1e9);
    ...
    static TestResult test5() {
        ...
        std::string suiteName = "MedianFilter3D_Test";
        std::string testName = "MedianFilter3D_Test: size=200^3, window_radius=3";
        ...
        //creates a Grayscale workspace of size 200^3
        //first variable is x domain size (in voxels), second is y, third is z. Fourth is voxelLength (in meters)
        puma::Workspace grayWS(50,50,50,1,1e-6,false);
    ...
    static TestResult test6() {
        ...
        std::string suiteName = "MedianFilter3D_Test";
        std::string testName = "MedianFilter3D_Test: size=1300^3, window_radius=1";
    ...
    static TestResult test7() {
        ...
        std::string suiteName = "MedianFilter3D_Test";
        std::string testName = "MedianFilter3D_Test: test case #1 on 5x5x1. Window_Radius=1";
        ...
        //the correct values of the median filter, computed by hand
        puma::Workspace expected(5,5,1,1e-6,false);
        expected.matrix(0,0,0) = 14;
        expected.matrix(1,0,0) = 12;
        expected.matrix(2,0,0) = 10;
        expected.matrix(3,0,0) = 14;
        expected.matrix(4,0,0) = 17;
        expected.matrix(0,1,0) = 12;
        expected.matrix(1,1,0) = 7;
        expected.matrix(2,1,0) = 7;
        expected.matrix(3,1,0) = 7;
        expected.matrix(4,1,0) = 14;
        expected.matrix(0,2,0) = 11;
        expected.matrix(1,2,0) = 8;
        expected.matrix(2,2,0) = 8;
        expected.matrix(3,2,0) = 8;
        expected.matrix(4,2,0) = 12;
        expected.matrix(0,3,0) = 17;
        expected.matrix(1,3,0) = 9;
        expected.matrix(2,3,0) = 9;
        expected.matrix(3,3,0) = 9;
        expected.matrix(4,3,0) = 16;
        expected.matrix(0,4,0) = 23;
        expected.matrix(1,4,0) = 17;
        expected.matrix(2,4,0) = 12;
        expected.matrix(3,4,0) = 16;
        expected.matrix(4,4,0) = 20;

        //in this case, the return should be true
        bool success = puma::filter_Median3D(&actual,1);
    ...
    static TestResult test8() {
        ...
        std::string suiteName = "MedianFilter3D_Test";
        std::string testName = "MedianFilter3D_Test: test case #1 on 5x5x1. Window_Radius=2";
        std::string testDescription = "Testing to make sure that the filtering algorithm gives the right result on a sample 5x5x1 workspace ";
        ...
        //the correct values of the median filter, computed by hand
        puma::Workspace expected(5,5,1,1e-6,false);
        expected.matrix(0,0,0) = 7;
        expected.matrix(1,0,0) = 8;
        expected.matrix(2,0,0) = 10;
        expected.matrix(3,0,0) = 8;
        expected.matrix(4,0,0) = 7;
        expected.matrix(0,1,0) = 9;
        expected.matrix(1,1,0) = 10;
        expected.matrix(2,1,0) = 11;
        expected.matrix(3,1,0) = 10;
        expected.matrix(4,1,0) = 9;
        expected.matrix(0,2,0) = 10;
        expected.matrix(1,2,0) = 11;
        expected.matrix(2,2,0) = 13;
        expected.matrix(3,2,0) = 11;
        expected.matrix(4,2,0) = 11;
        expected.matrix(0,3,0) = 9;
        expected.matrix(1,3,0) = 10;
        expected.matrix(2,3,0) = 11;
        expected.matrix(3,3,0) = 10;
        expected.matrix(4,3,0) = 10;
        expected.matrix(0,4,0) = 9;
        expected.matrix(1,4,0) = 10;
        expected.matrix(2,4,0) = 12;
        expected.matrix(3,4,0) = 10;
        expected.matrix(4,4,0) = 9;

        //in this case, the return should be true
        bool success = puma::filter_Median3D(&actual,2);
