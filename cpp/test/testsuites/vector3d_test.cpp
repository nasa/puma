...
class Vector3D_Test : public SubTest {
public:

    Vector3D_Test() {
        testSuiteName = "Vector3D_Test";
    ...
    static TestResult test1() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "Zero puma::Vec3<int> tests - construction";
        std::string testDescription = "Testing a zero puma::Vec3<int> using each constructor";
        TestResult result(suiteName, testName, 1, testDescription);

        puma::Vec3<int> intVec1;
        puma::Vec3<int> intVec2(0,0,0);
        puma::Vec3<int> intVec3(intVec1);
    ...
    static TestResult test2() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "Zero puma::Vec3<long> tests - construction";
        std::string testDescription = "Testing a zero puma::Vec3<long> using each constructor";
        TestResult result(suiteName, testName, 2, testDescription);

        puma::Vec3<long> longVec1;
        puma::Vec3<long> longVec2(0,0,0);
        puma::Vec3<long> longVec3(longVec1);
    ...
    static TestResult test3() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "Zero puma::Vec3<float> tests - construction";
        std::string testDescription = "Testing a zero puma::Vec3<float> using each constructor";
        TestResult result(suiteName, testName, 3, testDescription);

        puma::Vec3<float> floatVec1;
        puma::Vec3<float> floatVec2(0,0,0);
        puma::Vec3<float> floatVec3(floatVec1);
    ...
    static TestResult test4() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "Zero puma::Vec3<double> tests - construction";
        std::string testDescription = "Testing a zero puma::Vec3<double> using each constructor";
        TestResult result(suiteName, testName, 4, testDescription);

        puma::Vec3<double> doubleVec1;
        puma::Vec3<double> doubleVec2(0,0,0);
        puma::Vec3<double> doubleVec3(doubleVec1);
    ...
    static TestResult test5() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<double> tests: () operator";
        std::string testDescription;
        TestResult result(suiteName, testName, 5, testDescription);

        puma::Vec3<double> vec1;
        vec1(1.2,-1.2,1.2);
        puma::Vec3<double> vec2(1.2,-1.2,1.2);
    ...
    static TestResult test6() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<int> tests: () operator";
        std::string testDescription;
        TestResult result(suiteName, testName, 6, testDescription);

        puma::Vec3<int> vec1;
        vec1(1.2,-1.2,1.2);
        puma::Vec3<int> vec2(1.2,-1.2,1.2);
        ...
        puma::Vec3<int> vec5;
        vec5(1,-1,1);
        puma::Vec3<int> vec6(1.2,-1.2,1.2);
    ...
    static TestResult test7() {
        ...
        puma::Vec3<double> vec1;
        vec1(1.2,-1.2,1.2);
        puma::Vec3<double> vec2(1.3,-1.3,1.3);

        puma::Vec3<double> vec3(0.1,-0.1,0.1);
    ...
    static TestResult test8() {
        ...
        puma::Vec3<int> vec1;
        vec1(1,1,1);
        puma::Vec3<int> vec2(4,-5,8);

        puma::Vec3<int> vec3(3,-6,7);
    ...
    static TestResult test9() {
        ...
        puma::Vec3<double> vec3(2.5,-2.5,2.5);
    ...
    static TestResult test11() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<double> tests: * operator (positive double)";
        std::string testDescription;
        TestResult result(suiteName, testName, 11, testDescription);

        puma::Vec3<double> vec1;
        vec1(1.2,-1.2,1.2);
        puma::Vec3<double> vec2(3,-3,3);
    ...
    static TestResult test12() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<double> tests: * operator (negative double)";
        std::string testDescription;
    ...
    static TestResult test13() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<int> tests: * operator (positive int)";
        std::string testDescription;
        TestResult result(suiteName, testName, 13, testDescription);

        puma::Vec3<int> vec1;
        vec1(5,-6,7);
        puma::Vec3<int> vec2(10,-12,14);
    ...
    static TestResult test14() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<int> tests: * operator (negative int)";
        std::string testDescription;
    ...
    static TestResult test15() {
        ...
        puma::Vec3<double> vec1;
        vec1(1.2,-1.2,1.2);
        puma::Vec3<double> vec2(0.48,-0.48,0.48);
    ...
    static TestResult test19() {
        ...
        puma::Vec3<double> vec1(1.2,3.4,5.6);
        puma::Vec3<double> vec2(1.3,3.5,5.7);

        vec1=vec2;

        vec2(0,0,0);

        puma::Vec3<double> vec3(1.3,3.5,5.7);
    ...
    static TestResult test20() {
        ...
        puma::Vec3<int> vec1(2,4,6);
        puma::Vec3<int> vec2(3,5,7);

        vec1=vec2;

        vec2(0,0,0);

        puma::Vec3<int> vec3(3,5,7);
    ...
    static TestResult test21() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<double> tests: cross product";
        std::string testDescription;
        ...
        puma::Vec3<double> vec3(-38.98, 0.44, 8.62);
    ...
    static TestResult test22() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<float> tests: cross product";
        std::string testDescription;
        TestResult result(suiteName, testName, 22, testDescription);

        puma::Vec3<float> vec1(1.2,-3.4,5.6);
        puma::Vec3<float> vec2(1.3,3.5,5.7);

        puma::Vec3<float> vec3(-38.98, 0.44, 8.62);
    ...
    static TestResult test23() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<double> tests: dot product (values)";
        std::string testDescription;
    ...
    static TestResult test24() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<double> tests: dot product (zeros)";
        std::string testDescription;
        TestResult result(suiteName, testName, 24, testDescription);

        puma::Vec3<double> vec1(1.2,-3.4,5.6);
        puma::Vec3<double> vec2(0,0,0);
    ...
    static TestResult test25() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<float> tests: dot product (values)";
        std::string testDescription;
    ...
    static TestResult test26() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<float> tests: dot product (zeros)";
        std::string testDescription;
        TestResult result(suiteName, testName, 26, testDescription);

        puma::Vec3<float> vec1(1.2,-3.4,5.6);
        puma::Vec3<float> vec2(0,0,0);
    ...
    static TestResult test27() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<double> tests: norm";
        std::string testDescription;
        TestResult result(suiteName, testName, 24, testDescription);

        puma::Vec3<double> vec1(1,1,1);
        puma::Vec3<double> vec2 = vec1.norm();

        if(!myAssertEquals(vec1, puma::Vec3<double>(1,1,1), &result)) {
            return result;
        }
        if(!myAssertEquals(vec2, puma::Vec3<double>(1/sqrt(3),1/sqrt(3),1/sqrt(3)), &result)) {
            return result;
        }
    ...
    static TestResult test28() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<float> tests: norm";
        std::string testDescription;
        TestResult result(suiteName, testName, 24, testDescription);

        puma::Vec3<float> vec1(1,1,1);
        puma::Vec3<float> vec2 = vec1.norm();

        if(!myAssertEquals(vec1, puma::Vec3<float>(1,1,1), &result)) {
            return result;
        }
        if(!myAssertEquals(vec2, puma::Vec3<float>(1/sqrt(3),1/sqrt(3),1/sqrt(3)), &result)) {
            return result;
        }
    ...
    static TestResult test29() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<double> tests: magnitude";
        std::string testDescription;
        TestResult result(suiteName, testName, 24, testDescription);
    ...
    static TestResult test30() {
        std::string suiteName = "Vector3D Tests: ";
        std::string testName = "puma::Vec3<float> tests: magnitude";
        std::string testDescription;
        TestResult result(suiteName, testName, 24, testDescription);

        std::vector< puma::Vec3<float> > vecs;
        vecs.resize(3);
    ...
    static bool myAssertEquals(puma::Vec3<int> valExpected, puma::Vec3<int> valActual, TestResult *result) {

        if(valExpected.x==valActual.x && valExpected.y==valActual.y && valExpected.z==valActual.z) {
            result->failed=0;
        }
        else {
            result->failed=1;
    ...
    static bool myAssertEquals(puma::Vec3<long> valExpected, puma::Vec3<long> valActual, TestResult *result) {
