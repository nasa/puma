...
public:
    ...
    static TestResult test11() {
        ...
        puma::export_STL(&tpmsWS, puma::Cutoff(0,127), false, SubTest::puma_dir+"/cpp/test/out/stl/tpms_test.stl");
        puma::export_3DTiff(&tpmsWS, SubTest::puma_dir+"/cpp/test/out/stl/tpms_test.tif", false);
