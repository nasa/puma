...
public:
    ...
    static TestResult test9() {
        ...
        puma::export_3DTiff(&grayWS,SubTest::puma_dir+"/cpp/test/out/tiff/BilateralFilter_Test5_BeforeFilter.tif",false);
        ...
        puma::export_3DTiff(&grayWS,SubTest::puma_dir+"/cpp/test/out/tiff/BilateralFilter_Test5_AfterFilter.tif",false);
