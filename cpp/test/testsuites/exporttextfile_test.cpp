...
public:
    ...
    static TestResult test1() {
        ...
        bool success = puma::export_Textfile(&mat,SubTest::puma_dir+"/cpp/test/out/textfiles/export_textfile_Test1");
    ...
    static TestResult test2() {
        ...
        bool success = puma::export_Textfile(&mat,SubTest::puma_dir+"/cpp/test/out/abc/export_textfile_Test2");
    ...
    static TestResult test3() {
        ...
        bool success = puma::export_Textfile(&mat,SubTest::puma_dir+"/cpp/test/out/textfiles/export_textfile_Test3");
    ...
    static TestResult test4() {
        ...
        bool success = puma::export_Textfile(&mat,SubTest::puma_dir+"/cpp/test/out/textfiles/export_textfile_Test4");
    ...
    static TestResult test5() {
        ...
        bool success = puma::export_Textfile(&mat,SubTest::puma_dir+"/cpp/test/out/textfiles/export_textfile_Test5");
    ...
    static TestResult test6() {
        ...
        bool success = puma::export_Textfile(&mat,SubTest::puma_dir+"/cpp/test/out/textfiles/export_textfile_Test6",true,true,true,128,26);
    ...
    static TestResult test7() {
        ...
        bool success = puma::export_Textfile(&work,SubTest::puma_dir+"/cpp/test/out/textfiles/export_textfile_Test7");
    ...
    static TestResult test8() {
        ...
        bool success = puma::export_Textfile(&mat,SubTest::puma_dir+"/cpp/test/out/abc/export_textfile_Test8");
    ...
    static TestResult test9() {
        ...
        bool success = puma::export_Textfile(&work,SubTest::puma_dir+"/cpp/test/out/textfiles/export_textfile_Test9");
    ...
    static TestResult test10() {
        ...
        bool success = puma::export_Textfile(&work,SubTest::puma_dir+"/cpp/test/out/textfiles/export_textfile_Test10",true,true,true,128,26);
