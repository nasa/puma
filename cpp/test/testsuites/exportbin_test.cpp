...
public:
    ...
    static TestResult test1() {
        ...
        bool success = puma::export_bin(&workspace,puma::PString::get_puma_directory()+"cpp/test/out/bin/test1.puma");
    ...
    static TestResult test2() {
        ...
        bool success = puma::export_bin(&matrix,puma::PString::get_puma_directory()+"cpp/test/out/bin/test2.puma");
    ...
    static TestResult test3() {
        ...
        bool success = puma::export_bin(&matrix,puma::PString::get_puma_directory()+"cpp/test/out/bin/test3.puma");
    ...
    static TestResult test4() {
        ...
        bool success = puma::export_bin(&matrix,puma::PString::get_puma_directory()+"cpp/test/out/bin/test4.puma");
    ...
    static TestResult test5() {
        ...
        bool success = puma::export_bin(&matrix,puma::PString::get_puma_directory()+"cpp/test/out/bin/test5.puma");
    ...
    static TestResult test6() {
        ...
        bool success = puma::export_bin(&matrix,puma::PString::get_puma_directory()+"cpp/test/out/bin/test6.puma");
    ...
    static TestResult test7() {
        ...
        success = puma::export_bin(&workspace,puma::PString::get_puma_directory()+"cpp/test/out/bin/test.puma");
        if(!assertEquals((bool)true,success, &result)) {
            return result;
        }

        success = puma::export_bin(&workspace,puma::PString::get_puma_directory()+"cpp/test/out/bin/test");
        if(!assertEquals((bool)true,success, &result)) {
            return result;
        }
    ...
    static TestResult test8() {
        ...
        success = puma::export_bin(&matrix,puma::PString::get_puma_directory()+"cpp/test/out/bin/test.puma");
        if(!assertEquals((bool)true,success, &result)) {
            return result;
        }

        success = puma::export_bin(&matrix,puma::PString::get_puma_directory()+"cpp/test/out/bin/test");
        if(!assertEquals((bool)true,success, &result)) {
            return result;
        }
