...
ArtificialFlux_AMatrix::ArtificialFlux_AMatrix(puma::MatVec3<double> *q, puma::Matrix<double> *kMat, std::vector<FV_BoundaryCondition*> *bcs, int numThreads) {
    this->q = q;
    this->kMat = kMat;
    this->bcs = bcs;
...
bool ArtificialFlux_AMatrix::setup_KMinMax() {
    kX.resize( X+1, Y,   Z   );
    kY.resize( X,   Y+1, Z   );
    kZ.resize( X,   Y,   Z+1 );
...
bool ArtificialFlux_AMatrix::A_times_X(puma::Matrix<double> *x, puma::Matrix<double> *r) {
...
bool ArtificialFlux_AMatrix::setup_KMM_Interior() {
...
bool ArtificialFlux_AMatrix::setup_KMM_Boundaries() {
...
void ArtificialFlux_AMatrix::computeInteriorResidual(puma::Matrix<double> *x, puma::Matrix<double> *r) {
...
void ArtificialFlux_AMatrix::computeBoundaryResidual(puma::Matrix<double> *x, puma::Matrix<double> *r) {
...
puma::Vec3<double> ArtificialFlux_AMatrix::computeFluxes(puma::Matrix<double> *x, puma::MatVec3<double> *q, char dir ) {
