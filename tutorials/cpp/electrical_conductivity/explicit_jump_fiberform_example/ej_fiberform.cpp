...
// Initializing Workspace
    ...
    puma::export_STL(&ws, puma::Cutoff(90,255), false, "/Users/josephferguson/Desktop/teststl.stl");
...
// Running simulation in three directions
    puma::Vec3<double> sigma_x = puma::compute_EJElectricalConductivity(&ws, &V, matCond,'x',1e-3,10000,true);
    puma::Vec3<double> sigma_y = puma::compute_EJElectricalConductivity(&ws, &V, matCond,'y',1e-3,10000,true);
    puma::Vec3<double> sigma_z = puma::compute_EJElectricalConductivity(&ws, &V, matCond,'z',1e-3,10000,true);
