 ...
 */
     ...
     */
    input.curvedFlower_Hollow(100,100,100,5,0,100,0,0,0,0,true,0.95,100,120,0,1e-3,4,1,5,2,0,1,2.5,0);
    puma::generateRandomFibers(&grayWS, input);
    puma::export_STL(&grayWS, puma::Cutoff(128,255), false,"out/curved_flower_hollow_isotropic.stl");
