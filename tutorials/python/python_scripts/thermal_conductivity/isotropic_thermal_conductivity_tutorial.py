...
# example material used, the void phase is contained in grayscale range [0,89] and the solid phase is contained
# in the grayscale range of [90,255]. This range varies for each tomography sample.
# 
...
# Visualizing the temperature field for one of the three simulations:
