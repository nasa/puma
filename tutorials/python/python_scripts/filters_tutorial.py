...
# In this tutorial we show the use of the image filters implemented in pumapy. Most of the filters are simple wrappers
# of functions in either scikitimage or scipy.ndimage. The filters can be run directly in these packages if the user
# desires, but the wrapping is done for simplicity so that the Workspace class can be used, and the filter executions
# can be logged by the workspace class in order to document the simulation workflows.
