#ifndef EJ_Tortuosity_H
#define EJ_Tortuosity_H
 ...
 */
puma::Vec3<double> compute_EJTortuosity(Workspace *grayWS, puma::Matrix<double> *C, puma::Cutoff cutoff,
...
/*!
 *   An EJ_Tortuosity object is created and used by the compute_EJTortuosity() functions.
 *   \sa compute_EJTortuosity()
 */
class EJ_Tortuosity : MaterialProperty
{
public:
     ...
     * \param numThreads an integer which specifies the number of threads used for the simulation.
     */
    EJ_Tortuosity(puma::Workspace *segWS, puma::Matrix<double> *C, int voidSpace,
