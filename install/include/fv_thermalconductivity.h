#ifndef FV_THERMALCONDUCTIVITY_H
#define FV_THERMALCONDUCTIVITY_H
...
//! computes thermal conductivity from a grayscale workspace using the finite volume method.
/*!
 ...
 */
puma::Vec3<double> compute_FVThermalConductivity(Workspace *grayWS, puma::Matrix<double> *T, const std::map<int, double>& matCond,
 ...
 *   \sa compute_FVThermalConductivity()
 */
class FV_ThermalConductivity : MaterialProperty
{
public:
     ...
     * \param numThreads an integer which specifies the number of threads used for the simulation.
     */
    FV_ThermalConductivity(puma::Workspace *segWS, puma::Matrix<double> *T, std::map<int, double> matCond,
                           std::string sideBC, std::string solverType, char dir, double solverTol,
...
#endif // FV_THERMALCONDUCTIVITY_H
